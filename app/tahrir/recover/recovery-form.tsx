...
function NewPassword({ name, label }: { name: string; label: string }) {
  ...
  return <div className="grid gap-1.5">
    ...
    <div className="relative"><Input id={name} name={name} type={visible ? "text" : "password"} autoComplete="new-password" required minLength={15} maxLength={512} dir="ltr" className="h-11 ps-11" />
