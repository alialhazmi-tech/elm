    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          visits: stats.visits,
          lastVisitAt: stats.lastVisitAt,
          ...(storyEvents.some(event => event.type === "like" || event.type === "unlike") ? { liked: stats.liked } : {}),
          usedAi: stats.usedAi,
          aiTools: stats.aiTools,
          ...(storyEvents.some(event => event.type === "closing_answer") ? { closingAnswer: stats.closingAnswer } : {}),
          interestScore: stats.interestScore,
          updatedAt: nowIso,
        },
      });
