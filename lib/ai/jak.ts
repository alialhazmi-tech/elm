...
const PLAN_PROMPT = (title: string, source: string, canvas: JakCanvas) =>
  [
    ...
    "- imagePrompt بالإنجليزية: مشهد جوي atmospheric cinematic يعبر عن معنى الشريحة،",
    "  بألوان كحلية داكنة وذهبية، بلا أشخاص وبلا نصوص داخل الصورة. اتركه فارغًا لشرائح",
