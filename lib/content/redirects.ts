...
export const LEGACY_REDIRECTS: LegacyRedirect[] = [
  ...
  // مواد «غير مصنف» الثلاثية يحسمها حارس canonical بالمعرّف، لكن الشكل الثنائي القديم
  // /غير-مصنف/:id يصل أحيانًا من أدوات خارجية — يقاس على القسم الصحيح.
  redirect("/غير-مصنف/:id(\\d+)", "/varieties/:id"),
  redirect("/uncategorized/:id(\\d+)", "/varieties/:id"),
];
