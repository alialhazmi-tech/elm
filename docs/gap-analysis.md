...
| Policy Guard وAI | غير موجود | rules/validators/provider abstraction/governance/evals | M4 | P0 | وثيقة السياسة الأصلية + provider | حرج |
...
2. إيداع وثيقة «الآلية العامة وسياسة التحرير لمشروع العلم» في المستودع؛ هي المصدر الملزم لقواعد Policy Guard.
