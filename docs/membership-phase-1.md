...
> الحالة: **النواة التشغيلية مطبقة**. التسجيل والجلسات عبر Neon Auth، وملف العضو واهتماماته وصفحة «لك» مطبقة في قاعدة مستقلة عن مستخدمي التحرير. إشارات القراءة والإعجاب ومحرك الترتيب الشخصي مطبقة فوق الحساب المسجّل.
