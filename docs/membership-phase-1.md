# عضوية العلم — قرار المرحلة الأولى والنموذج التجريبي

> الحالة: **نموذج للمراجعة فقط**. لا توجد هجرة قاعدة بيانات، ولا تسجيل دخول حقيقي، ولا كتابة في بيانات الإنتاج. المسار التجريبي محجوب في بيئة الإنتاج افتراضيًا.
...
- لا توجد جداول عضوية جمهور حاليًا، ولم نغيّر `db/schema.ts`.
...
## 4. مخطط البيانات المقترح — غير مطبّق

الأسماء أدناه تصميم للنقاش وليست migration.
