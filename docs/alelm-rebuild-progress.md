...
| M2 | بذرة محتوى حقيقية بدل الوهمي | DONE | 34 مادة منشورة من alelm.net بعناوينها وصورها وتواريخها وأقسامها، موزعة على السلاسل التسع؛ حُذف `mock-provider` | `lib/content/seed.ts`, `lib/content/provider.ts` | فك كيانات HTML وتنظيف `[…]` متحقق منه | البذرة لقطة لا مصدر حي | استبدالها بالمحوّل |
