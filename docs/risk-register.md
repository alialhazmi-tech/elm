...
مراجعة 13 سبتمبر: خطر مدخل Railway المباشر لا يغلق بالكود وحده؛ يلزم تفعيل ORIGIN_AUTH_ENFORCE بعد إعداد Cloudflare والتحقق الحي. CSP العامة والسعة الفعلية وتغطية MFA تبقى موضحة كحدود تحقق في `docs/audit/remediation-2026-09-13.md`.

| ID | الحالة | الخطر/العائق | الاحتمال | الأثر | التخفيف | المطلوب |
|---|---|---|---|---|---|---|
| R-16 | MITIGATED IN CODE | نتائج عربية فارغة كاذبة بسبب اختلاف تطبيع الاستعلام والفهرس العام | مؤكد | مرتفع | تطبيع مشترك، ترحيل 0017 لإعادة حساب الموجود، إبطال كاش البحث بتغيير نسخته، واختبارات نتائج معروفة مستقلة عن SQL | تطبيق الترحيل بعد النسخ الاحتياطي وفحص «الشيخوخة» على الموقع بعد النشر |
