...
export function Forbidden({ title, permission, message }: { title: string; permission: string; message?: string }) {
  return (
    <main className="flex flex-col gap-3">
      ...
      <Card className="grid place-items-center gap-2 px-4 py-10 text-center">
        ...
        <p className="text-sm">{message ?? "ليست لديك صلاحية هذه الشاشة."}</p>
